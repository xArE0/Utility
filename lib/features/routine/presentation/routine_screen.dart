...
class _RoutineScreenState extends State<RoutineScreen>
  ...
  void _showAddEditDialog(
      {int? editId, String? editName, String? editEmoji, String? editTime}) {
    ...
    showDialog(
        ...
        builder: (ctx) => StatefulBuilder(
              builder: (ctx, ss) => AlertDialog(
                ...
                title: Text(editId == null ? 'New Habit' : 'Edit Habit',
                        ...
                        return GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              color: sel
                                  ? AppColors.govBlue.withValues(alpha: 0.3)
                ...
                actions: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      if (editId != null) {
                        _ctrl.updateHabit(editId, name, emoji,
                            scheduledTime: time, clearTime: time == null);
                      } else {
  ...
  void _confirmDelete(int id, String name) {
    showDialog(
        ...
        builder: (ctx) => AlertDialog(
              ...
              content: Text('This removes all its history too.',
  ...
  Widget _buildTodayTab() {
    if (_ctrl.habits.isEmpty) {
      return Center(
        ...
        Text('No habits yet',
            style:
                AppTypography.titleLarge.copyWith(color: AppColors.slate300)),
        const SizedBox(height: 8),
    ...
    return ListView(
        ...
        children: [
          _ProgressRing(
              progress: _ctrl.todayProgress,
              completed: _ctrl.completedToday,
              total: _ctrl.totalHabits),
                ...
                child: Row(children: [
                  ...
                  Expanded(
                      child: Column(
                        ...
                        if (hasTime)
                          Text(_fmtTime(habit.scheduledTime!),
                              style: TextStyle(
  ...
  void _showBottomOptions(Habit habit) {
    showModalBottomSheet(
      ...
      builder: (ctx) => SafeArea(
        ...
        const SizedBox(height: 16),
        ListTile(
            leading: const Icon(Icons.edit, color: AppColors.govGold),
        ...
        children: [
          Text('CONSISTENCY',
              style: AppTypography.labelLarge
                  .copyWith(color: AppColors.slate400, letterSpacing: 1.2)),
          ...
          ..._ctrl.habits.map((h) => _HabitHistoryRow(
              habit: h,
              streak: _ctrl.getStreak(h.id!),
              bestStreak: _ctrl.getBestStreak(h.id!),
            ...
            ...List.generate(
                ...
                (w) => SizedBox(
                    ...
                    child: monthLabels.containsKey(w)
                        ? Text(monthLabels[w]!,
                            style: TextStyle(
                                fontSize: 9, color: AppColors.slate500))
                        : null)),
          ])),
      ...List.generate(7, (di) {
        ...
        return Row(children: [
          ...
          ...List.generate(weeks, (w) {
            ...
            final intensity =
                maxPerDay > 0 ? (count / maxPerDay).clamp(0.0, 1.0) : 0.0;
            return Padding(
                padding: const EdgeInsets.all(gap / 2),
                child: Tooltip(
                    message: '$ds: $count/$maxPerDay',
                    child: Container(
                        width: cellSize,
                        height: cellSize,
                        decoration: BoxDecoration(
...
class _HabitHistoryRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          color: AppColors.slate800.withValues(alpha: 0.7),
          borderRadius: BorderRadius.circular(14),
